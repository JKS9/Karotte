                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="<?= routeUrl() ?>AddAnAd"><span class="glyphicon glyphicon-plus"></span>Add an ad</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?= routeUrl() ?>Delivery"><span class="glyphicon glyphicon-list"
                                                                                  style="margin-right: 5px"></span>Delivery</a>
                                    </li>
                                    <li><a href="<?= routeUrl() ?>AdHistory/"><span class="glyphicon glyphicon-list"
                                                                                   style="margin-right: 5px"></span>ad history</a></li>
